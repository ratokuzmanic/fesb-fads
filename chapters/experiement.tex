...
serija. Originalno, presnimavanje se vršilo putem OBS Studio softvera, s izlaznim formatom MP4 (MPEG-4 kompresija), 4500 b/s video brzinom i
...
korištenjem FFmpeg alata su videomaterijali prikupljen s HBO GO platforme normalizirani na referentnu vrijednost od 23.98 slika
u sekundi.
\begin{lstlisting}
...
./ffmpeg -i tagged_hbo-go_normalized_short.mp4 -vf "select=eq(pict_type\,I)" -vsync vfr hbo-go/frame%04d.png -hide_banner
    ...
    informacije su dani slikom ~\ref{img:visualAttackPlanes}.
...
./ffmpeg -i tagged_go90_short.mp4 -vf "select=eq(pict_type\,I)" -vsync vfr go90/frame%04d.png -hide_banner
    ...
    je prikazano slikom ~\ref{img:diffPlanes}.
    ...
    nužno biti pokazatelj steganografskih informacija, već potencijalno posljedica kodiranja i kompresije. 
    ...
    prijelaze ovisno o verziji, stoga je moguće da i montažom samog sadržaja se utječe na mogućnost profiliranja.
    \begin{figure}[H]
        \centering
