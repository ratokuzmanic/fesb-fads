\section{Uvod}
Porastom popularnosti OTT (engl. \texit{Over the Top}) multimedijalnih servisa poput 
...
primitivnim oblicima napada poput presnimavanja. Kako bi se omogućilo određivanja identiteta
inicijalnog pirata samog sadržaja, u sustav zaštite se uvode i stenografske metodologije i
tehnike skrivenog vodenog žiga, gdje se na korisniku neprimjetan način uvodi jedinstveni 
identifikator sesije.

Cilj ovog seminarskog rada je na praktičnom primjeru serije t@gged s HBO GO platforme
provesti stegoanalizu i pokušati pronaći dokaze identificirajućih podataka pohranjenih
u sami video zapis.
