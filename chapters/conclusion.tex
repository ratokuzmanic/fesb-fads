...
steganografskih informacija unutar video sadržaja nije vjerojatno. Pritom postoji osnovica za daljnji razvoj
i istraživanja ove teme, od same metodologije rada pa do povećanja broja testiranih video sadržaja, kao i OTT
platformi. Od posebnog interesa bi pritom moglo biti istraživanje Netflixa, s obzirom na tehnološku razvijenost 
istog.

U vidu proširenja metoda rada i povećanja intervala sigurnosti u dani zaključak, može se provesti i frekvencijska
...
onima posluženim na drugim platformama ili drugim korisnicima. 

Također, s obzirom na adaptivnu prirodu toka bitova unutar 
